...
import { Github, Linkedin, Mail, Radio } from 'lucide-react' // Import Icons
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="space-y-6">
          ...
          <div className="text-slate-500 space-y-2 text-xs leading-relaxed">
            <p>// Architecture: Headless / Static</p>
            <p>// Database: Supabase Edge</p>
        ...
        <div className="space-y-6">
          ...
          <p className="text-xs text-slate-600">Encrypted channels open 24/7.</p>
        </div>
      </div>
