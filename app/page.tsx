    ...
    <main className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-cyan-500/30">
      ...
      <section id="services" className="pt-24 pb-12 px-4 bg-slate-950 relative border-b border-blue-900/30">
        <div className="max-w-4xl mx-auto text-center mb-12">
            <h3 className="text-lg sm:text-2xl md:text-3xl font-mono text-white flex items-center justify-center gap-2 md:gap-3 whitespace-nowrap">
               // ARCHITECTURAL_SERVICES
               <Layers className="w-6 h-6 md:w-8 md:h-8 text-cyan-500" />
            </h3>
        </div>
        <Services />
      </section>
      ...
      <section id="experience" className="py-24 px-4 bg-slate-950 border-b border-blue-900/30">
        <div className="max-w-4xl mx-auto text-center mb-16">
            <h3 className="text-lg sm:text-2xl md:text-3xl font-mono text-white flex items-center justify-center gap-2 md:gap-3 whitespace-nowrap">
               // DEPLOYED_SOLUTIONS
               <Code2 className="w-6 h-6 md:w-8 md:h-8 text-cyan-500" />
            </h3>
            <p className="text-slate-400 mt-4 text-xs md:text-sm font-mono">[ PROVEN IN PRODUCTION ]</p>
        </div>
        <Deployments />
      </section>
      ...
      <section id="projects" className="py-24 px-4 bg-slate-950 border-b border-blue-900/30">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12 text-center">
            <h3 className="text-lg sm:text-2xl md:text-3xl font-mono text-white mb-2 whitespace-nowrap">
              // PROJECT_INDEX
            </h3>
            <p className="text-slate-400 font-mono text-xs md:text-sm">Synchronized from GitHub (Cached)</p>
          </div>
          <ProjectGrid /> 
        </div>
      </section>
      ...
      <section id="specs" className="py-24 px-4 bg-slate-950 border-b border-blue-900/30">
         <div className="max-w-4xl mx-auto text-center mb-12">
             <h3 className="text-lg sm:text-2xl md:text-3xl font-mono text-white flex items-center justify-center gap-2 md:gap-3 whitespace-nowrap">
               // PORTAL_ARCHITECTURE
               <Terminal className="w-6 h-6 md:w-8 md:h-8 text-cyan-500" />
             </h3>
         </div>
         <SiteSpecs />
      </section>
      ...
      <section id="contact" className="pt-24 pb-24 px-4 bg-slate-950 relative border-b border-blue-900/30">
         <div className="max-w-4xl mx-auto text-center mb-12">
            <h3 className="text-lg sm:text-2xl md:text-3xl font-mono text-white mb-4 whitespace-nowrap">
              // SECURE_UPLINK
            </h3>
            <p className="text-slate-400 text-sm">Initialize handshake to request collaboration.</p>
         </div>
         <Contact />
      </section>
